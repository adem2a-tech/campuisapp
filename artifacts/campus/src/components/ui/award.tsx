...
export function Awards({
      ...
      <div className={cn("relative mx-auto flex h-48 w-48 items-center justify-center", className)}>
        <svg className="absolute inset-0 h-full w-full" viewBox="0 0 192 192" xmlns="http://www.w3.org/2000/svg">
          ...
          <text className="fill-white text-xl font-bold">
            <textPath href="#top-curve" startOffset="50%" textAnchor="middle" className="fill-black dark:fill-white">{title}</textPath>
          </text>
          <text className="text-[10px] tracking-wider">
            <textPath href="#bottom-curve" startOffset="50%" textAnchor="middle" className="fill-black dark:fill-white">{subtitle}</textPath>
          </text>
        </svg>
  ...
  if (variant === "award") {
    const LaurelWreath = () => (
      <svg className={cn("fill-primary absolute top-1/2 h-full w-full -translate-y-1/2")} width="892.77" height="688.08" viewBox="0 0 892.77 688.08">
    ...
    return (
      <div className={cn("relative z-0 flex flex-col items-center justify-center overflow-hidden p-6", className)}>
        ...
        <div className="z-10 px-8 text-center">
          <div className={cn("mt-6 mb-2 inline-block rounded-md px-4 py-1 tracking-wider text-white", `bg-gradient-to-r ${levelColors[level]}`)}>
            {level.toUpperCase()}
          </div>
  ...
  if (variant === "certificate") {
    return (
      <div className={cn("relative z-0 flex flex-col items-center justify-center overflow-hidden rounded-xl border-2 border-dotted p-2", className)}>
        <div className="bg-card z-10 rounded-sm border p-6 px-8 text-center">
          <Award strokeWidth={1} className="fill-primary mx-auto -mt-2 h-10 w-10" />
          ...
          <div className="mt-6 flex justify-center"><Award strokeWidth={1} className="h-4 w-4" /></div>
  ...
  if (variant === "badge") {
    return (
      <div className={cn("", className)}>
        <div className={cn("flex justify-start gap-3 rounded-md border-4 p-4")}>
          <Award className="fill-primary text-primary h-14 w-14 shrink-0" strokeWidth={1.2} />
    ...
    return (
      <div className={cn("relative inline-flex -rotate-5 transform items-center justify-center", className)}>
        <div className="relative text-center">
          <span className="text-primary relative text-7xl font-black tracking-tighter">{title}</span>
        </div>
      </div>
    )
  }
  ...
  if (variant === "id-card") {
    return (
      <div className={cn("bg-card flex items-center justify-center rounded-md border p-1 shadow-lg", className)}>
        <div className="relative h-100 w-72 overflow-hidden rounded-sm border-4">
